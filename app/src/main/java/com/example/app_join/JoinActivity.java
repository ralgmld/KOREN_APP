...
public class JoinActivity extends AppCompatActivity  {
    private EditText join_id, join_password, join_name, join_pwck,join_phone_num,join_rrn,join_read,numcheck;
    private Button join_button, check_button,btn_change;
